...
const About = () => {
  return (
    <div className="p-20 mx-auto max-w-[1190px] h-full">
      <div>
        ...
        <p className="text-info text-[16px]">
          ...
          information. <br /> <br />
          When we refer to “Substance”, we mean the Substance entity that acts
          as the controller or processor of your information, as explained in
          more detail in the “Identifying the Data Controller and Processor”
          section below.
        </p>

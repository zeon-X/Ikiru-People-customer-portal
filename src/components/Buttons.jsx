...
// const ActiveBillingBtn = ({ btnText }) => {
//   return (
//     <button className="flex justify-between items-center gap-4 bg-[#FF8A00] rounded-lg px-8 py-4 text-white">
...
const BillingBtn = ({ btnText, isActive, index, onClickFunc }) => {
  return isActive ? (
    ...
    <button
      ...
      className="flex justify-start items-center gap-4 bg-white rounded-lg px-8 py-4 text-info border border-info"
    >
      <p className="text-[14px] font-medium">{btnText}</p>
    </button>
  );
